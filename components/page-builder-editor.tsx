  ...
  return (
    <div className="grid gap-3 rounded-md border border-neutral-200 p-3 dark:border-neutral-800">
      ...
      <label className="flex items-center gap-2 text-sm font-medium text-neutral-700 dark:text-neutral-200">
        <input
          checked={block.settings.fontWeight === "bold"}
          className="h-4 w-4 rounded border-neutral-300 text-neutral-950 focus:ring-emerald-500 dark:border-neutral-700"
          onChange={(event) =>
            updateSettings({
              fontWeight: event.target.checked ? "bold" : undefined
            })
          }
          type="checkbox"
        />
