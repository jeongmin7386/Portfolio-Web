...
import { getAllCategories, getAllProjects } from "@/lib/content";
...
export const metadata: Metadata = {
  title: "프로젝트",
  description:
    "브랜딩, UI/UX, 에디토리얼, 모션, 아트 디렉션 작업을 모은 프로젝트 아카이브."
};
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <section className="pb-8 pt-8">
        ...
        <p className="mt-6 max-w-2xl text-base leading-8 text-neutral-600 dark:text-neutral-300">
          분야별 작업을 그리드로 정리했습니다. 콘텐츠가 늘어나도 한눈에
          살펴볼 수 있도록 여백과 구조를 유지합니다.
        </p>
      </section>
      <section className="pb-16">
        <SectionTitle
          ...
          title="케이스 스터디"
        />
        <ProjectExplorer categories={categories} projects={projects} />
      </section>
    </div>
  );
}
