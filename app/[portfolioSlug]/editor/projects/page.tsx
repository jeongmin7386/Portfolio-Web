...
export const metadata: Metadata = {
  title: "프로젝트 편집",
  description: "승인된 사용자용 Studio 낙화 프로젝트 편집 화면.",
  robots: {
    index: false,
    follow: false
  }
...
type UserProjectsEditorPageProps = {
  params: Promise<{
    portfolioSlug: string;
  }>;
};

export default async function UserProjectsEditorPage({
  params
}: UserProjectsEditorPageProps) {
